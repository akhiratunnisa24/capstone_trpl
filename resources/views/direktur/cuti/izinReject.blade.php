{{-- FORM ALASAN DITOLAK --}}
<div class="modal fade" id="izinTolak{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="input" action="{{ route('permission.rejected',$data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
