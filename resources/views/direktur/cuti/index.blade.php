                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 col-xs-12">
                                                        <div class="m-t-20">
                                                            <div class="form-group">
                                                                <label>Bulan</label>
                                                                <select name="bulans" id="bulans" class="col-md-3 form-control selectpicker" data-live-search="true" required>
                                                                    <option value="">-- Pilih Bulan --</option>
                                                                    <option value="01" {{ ('01' === request()->bulans) ? 'selected' : '' }}>Januari</option>
                                                                    <option value="02" {{ ('02' === request()->bulans) ? 'selected' : '' }}>Februari</option>
                                                                    <option value="03" {{ ('03' === request()->bulans) ? 'selected' : '' }}>Maret</option>
                                                                    <option value="04" {{ ('04' === request()->bulans) ? 'selected' : '' }}>April</option>
                                                                    <option value="05" {{ ('05' === request()->bulans) ? 'selected' : '' }}>Mei</option>
                                                                    <option value="06" {{ ('06' === request()->bulans) ? 'selected' : '' }}>Juni</option>
                                                                    <option value="07" {{ ('07' === request()->bulans) ? 'selected' : '' }}>Juli</option>
                                                                    <option value="08" {{ ('08' === request()->bulans) ? 'selected' : '' }}>Agustus</option>
                                                                    <option value="09" {{ ('09' === request()->bulans) ? 'selected' : '' }}>September</option>
                                                                    <option value="10" {{ ('10' === request()->bulans) ? 'selected' : '' }}>Oktober</option>
                                                                    <option value="11" {{ ('11' === request()->bulans) ? 'selected' : '' }}>November</option>
                                                                    <option value="12" {{ ('12' === request()->bulans) ? 'selected' : '' }}>Desember</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 col-xs-12">
                                                        <div class="m-t-20">
                                                            <div class="form-group">
                                                                <label>Tahun</label>
                                                                <select name="tahuns" id="tahuns" class="col-md-3 form-control selectpicker" data-live-search="true" required>
                                                                    <option value="" required>-- Pilih Tahun --</option>
                                                                    {{-- {{ ('01' === request()->bulans) ? 'selected' : '' }} --}}
                                                                    <option value="2020" {{ ('2020' === request()->tahuns) ? 'selected' : '' }}>2020</option>
                                                                    <option value="2021" {{ ('2021' === request()->tahuns) ? 'selected' : '' }}>2021</option>
                                                                    <option value="2022" {{ ('2022' === request()->tahuns) ? 'selected' : '' }}>2022</option>
                                                                    <option value="2023" {{ ('2023' === request()->tahuns) ? 'selected' : '' }}>2023</option>
                                                                    <option value="2024" {{ ('2024' === request()->tahuns) ? 'selected' : '' }}>2024</option>
                                                                    <option value="2025" {{ ('2025' === request()->tahuns) ? 'selected' : '' }}>2025</option>
                                                                    <option value="2026" {{ ('2026' === request()->tahuns) ? 'selected' : '' }}>2026</option>
                                                                    <option value="2027" {{ ('2027' === request()->tahuns) ? 'selected' : '' }}>2027</option>
                                                                    <option value="2028" {{ ('2028' === request()->tahuns) ? 'selected' : '' }}>2028</option>
                                                                    <option value="2029" {{ ('2029' === request()->tahuns) ? 'selected' : '' }}>2029</option>
                                                                    <option value="2030" {{ ('2030' === request()->tahuns) ? 'selected' : '' }}>2030</option>
                                                                    <option value="2011" {{ ('2011' === request()->tahuns) ? 'selected' : '' }}>2031</option>
                                                                    <option value="2012" {{ ('2012' === request()->tahuns) ? 'selected' : '' }}>2032</option>
                                                                    <option value="2013" {{ ('2013' === request()->tahuns) ? 'selected' : '' }}>2033</option>
                                                                    <option value="2014" {{ ('2014' === request()->tahuns) ? 'selected' : '' }}>2034</option>
                                                                    <option value="2015" {{ ('2015' === request()->tahuns) ? 'selected' : '' }}>2035</option>
                                                                    <option value="2016" {{ ('2016' === request()->tahuns) ? 'selected' : '' }}>2036</option>
                                                                    <option value="2017" {{ ('2017' === request()->tahuns) ? 'selected' : '' }}>2037</option>
                                                                    <option value="2018" {{ ('2018' === request()->tahuns) ? 'selected' : '' }}>2038</option>
                                                                    <option value="2019" {{ ('2019' === request()->tahuns) ? 'selected' : '' }}>2039</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="m-t-20">
                                                    <div class="form-group">
                                                        <label>Bulan</label>
                                                        <select name="months" id="months" class="col-md-3 form-control selectpicker" data-live-search="true" required>
                                                            <option value="">-- Pilih Bulan --</option>
                                                            <option value="01" {{ ('01' === request()->months) ? 'selected' : '' }}>Januari</option>
                                                            <option value="02" {{ ('02' === request()->months) ? 'selected' : '' }}>Februari</option>
                                                            <option value="03" {{ ('03' === request()->months) ? 'selected' : '' }}>Maret</option>
                                                            <option value="04" {{ ('04' === request()->months) ? 'selected' : '' }}>April</option>
                                                            <option value="05" {{ ('05' === request()->months) ? 'selected' : '' }}>Mei</option>
                                                            <option value="06" {{ ('06' === request()->months) ? 'selected' : '' }}>Juni</option>
                                                            <option value="07" {{ ('07' === request()->months) ? 'selected' : '' }}>Juli</option>
                                                            <option value="08" {{ ('08' === request()->months) ? 'selected' : '' }}>Agustus</option>
                                                            <option value="09" {{ ('09' === request()->months) ? 'selected' : '' }}>September</option>
                                                            <option value="10" {{ ('10' === request()->months) ? 'selected' : '' }}>Oktober</option>
                                                            <option value="11" {{ ('11' === request()->months) ? 'selected' : '' }}>November</option>
                                                            <option value="12" {{ ('12' === request()->months) ? 'selected' : '' }}>Desember</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="m-t-20">
                                                    <div class="form-group">
                                                        <label>Tahun</label>
                                                        <select name="years" id="years" class="col-md-3 form-control selectpicker" data-live-search="true" required>
                                                            <option value="" required>-- Pilih Tahun --</option>
                                                            {{-- {{ ('01' === request()->bulans) ? 'selected' : '' }} --}}
                                                            <option value="2020" {{ ('2020' === request()->years) ? 'selected' : '' }}>2020</option>
                                                            <option value="2021" {{ ('2021' === request()->years) ? 'selected' : '' }}>2021</option>
                                                            <option value="2022" {{ ('2022' === request()->years) ? 'selected' : '' }}>2022</option>
                                                            <option value="2023" {{ ('2023' === request()->years) ? 'selected' : '' }}>2023</option>
                                                            <option value="2024" {{ ('2024' === request()->years) ? 'selected' : '' }}>2024</option>
                                                            <option value="2025" {{ ('2025' === request()->years) ? 'selected' : '' }}>2025</option>
                                                            <option value="2026" {{ ('2026' === request()->years) ? 'selected' : '' }}>2026</option>
                                                            <option value="2027" {{ ('2027' === request()->years) ? 'selected' : '' }}>2027</option>
                                                            <option value="2028" {{ ('2028' === request()->years) ? 'selected' : '' }}>2028</option>
                                                            <option value="2029" {{ ('2029' === request()->years) ? 'selected' : '' }}>2029</option>
                                                            <option value="2030" {{ ('2030' === request()->years) ? 'selected' : '' }}>2030</option>
                                                            <option value="2011" {{ ('2011' === request()->years) ? 'selected' : '' }}>2031</option>
                                                            <option value="2012" {{ ('2012' === request()->years) ? 'selected' : '' }}>2032</option>
                                                            <option value="2013" {{ ('2013' === request()->years) ? 'selected' : '' }}>2033</option>
                                                            <option value="2014" {{ ('2014' === request()->years) ? 'selected' : '' }}>2034</option>
                                                            <option value="2015" {{ ('2015' === request()->years) ? 'selected' : '' }}>2035</option>
                                                            <option value="2016" {{ ('2016' === request()->years) ? 'selected' : '' }}>2036</option>
                                                            <option value="2017" {{ ('2017' === request()->years) ? 'selected' : '' }}>2037</option>
                                                            <option value="2018" {{ ('2018' === request()->years) ? 'selected' : '' }}>2038</option>
                                                            <option value="2019" {{ ('2019' === request()->years) ? 'selected' : '' }}>2039</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
