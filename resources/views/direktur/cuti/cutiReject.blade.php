{{-- FORM ALASAN DITOLAK --}}
<div class="modal fade" id="cutisTolak{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="input" action="{{ route('leave.rejected',$data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
