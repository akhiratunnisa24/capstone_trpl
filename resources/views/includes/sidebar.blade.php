            ...
            <div id="sidebar-menu">
                <ul>
                    <li><a href="/" class="waves-effect"><i class="ti-home"></i><span
                        class="text-info panel-title">Dashboard</span></a>
                    </li>
                    <li><a href="/prediksi-resign" class="waves-effect"><i class="ti-user"></i><span
                        class="text-info panel-title">Prediksi Resign</span></a>
                    </li>
                                <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="/riwayat-absensi"><i class="fa fa-history"></i><span>Riwayat Absensi</span></a></li>
