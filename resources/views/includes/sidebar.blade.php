        ...
        <div class="user-details">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub">
                        <a id="menuAbsensi" href="javascript:void(0);" class="waves-effect"><i class="ti-menu-alt"></i><span>Data Absensi</span><span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                    ...
                    <li class="has_sub">
                        <a id="menuCuti" href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-walk"></i> <span>Cuti & Izin</span><span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                        <ul class="list-unstyled">
