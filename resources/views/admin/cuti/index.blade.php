                                                ...
                                                <div class="m-t-20">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bulan" id="bulan"
                                                            ...
                                                            <option value="01"
                                                                {{ '01' === request()->bulan ? 'selected' : '' }}>Januari
                                                            </option>
                                                            <option value="02"
                                                                {{ '02' === request()->bulan ? 'selected' : '' }}>Februari
                                                            </option>
                                                            <option value="03"
                                                                {{ '03' === request()->bulan ? 'selected' : '' }}>Maret
                                                            </option>
                                                            <option value="04"
                                                                {{ '04' === request()->bulan ? 'selected' : '' }}>April
                                                            </option>
                                                            <option value="05"
                                                                {{ '05' === request()->bulan ? 'selected' : '' }}>Mei
                                                            </option>
                                                            <option value="06"
                                                                {{ '06' === request()->bulan ? 'selected' : '' }}>Juni
                                                            </option>
                                                            <option value="07"
                                                                {{ '07' === request()->bulan ? 'selected' : '' }}>Juli
                                                            </option>
                                                            <option value="08"
                                                                {{ '08' === request()->bulan ? 'selected' : '' }}>Agustus
                                                            </option>
                                                            <option value="09"
                                                                {{ '09' === request()->bulan ? 'selected' : '' }}>
                                                                September</option>
                                                            <option value="10"
                                                                {{ '10' === request()->bulan ? 'selected' : '' }}>Oktober
                                                            </option>
                                                            <option value="11"
                                                                {{ '11' === request()->bulan ? 'selected' : '' }}>
                                                                November</option>
                                                            <option value="12"
                                                                {{ '12' === request()->bulan ? 'selected' : '' }}>
                                                                Desember</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="m-t-20">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tahun" id="tahun"
                                                            ...
                                                            <option value="2020"
                                                                {{ '2020' === request()->tahun ? 'selected' : '' }}>2020
                                                            </option>
                                                            <option value="2021"
                                                                {{ '2021' === request()->tahun ? 'selected' : '' }}>2021
                                                            </option>
                                                            <option value="2022"
                                                                {{ '2022' === request()->tahun ? 'selected' : '' }}>2022
                                                            </option>
                                                            <option value="2023"
                                                                {{ '2023' === request()->tahun ? 'selected' : '' }}>2023
                                                            </option>
                                                            <option value="2024"
                                                                {{ '2024' === request()->tahun ? 'selected' : '' }}>2024
                                                            </option>
                                                            <option value="2025"
                                                                {{ '2025' === request()->tahun ? 'selected' : '' }}>2025
                                                            </option>
                                                            <option value="2026"
                                                                {{ '2026' === request()->tahun ? 'selected' : '' }}>2026
                                                            </option>
                                                            <option value="2027"
                                                                {{ '2027' === request()->tahun ? 'selected' : '' }}>2027
                                                            </option>
                                                            <option value="2028"
                                                                {{ '2028' === request()->tahun ? 'selected' : '' }}>2028
                                                            </option>
                                                            <option value="2029"
                                                                {{ '2029' === request()->tahun ? 'selected' : '' }}>2029
                                                            </option>
                                                            <option value="2030"
                                                                {{ '2030' === request()->tahun ? 'selected' : '' }}>2030
                                                            </option>
                                                            <option value="2011"
                                                                {{ '2011' === request()->tahun ? 'selected' : '' }}>2031
                                                            </option>
                                                            <option value="2012"
                                                                {{ '2012' === request()->tahun ? 'selected' : '' }}>2032
                                                            </option>
                                                            <option value="2013"
                                                                {{ '2013' === request()->tahun ? 'selected' : '' }}>2033
                                                            </option>
                                                            <option value="2014"
                                                                {{ '2014' === request()->tahun ? 'selected' : '' }}>2034
                                                            </option>
                                                            <option value="2015"
                                                                {{ '2015' === request()->tahun ? 'selected' : '' }}>2035
                                                            </option>
                                                            <option value="2016"
                                                                {{ '2016' === request()->tahun ? 'selected' : '' }}>2036
                                                            </option>
                                                            <option value="2017"
                                                                {{ '2017' === request()->tahun ? 'selected' : '' }}>2037
                                                            </option>
                                                            <option value="2018"
                                                                {{ '2018' === request()->tahun ? 'selected' : '' }}>2038
                                                            </option>
                                                            <option value="2019"
                                                                {{ '2019' === request()->tahun ? 'selected' : '' }}>2039
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel-body m-b-5">
                                            <div class="row">
                                                <div class="col-md-20 col-sm-20 col-xs-20">
                                                    <table id="datatable-responsive18"
                                                                    ...
                                                                    <td id="b" class="text-center">
                                                                        <div class="row">
                                                                            @if ($data->atasan_pertama == Auth::user()->id_pegawai && $data->status == 1)
                                                                                <div class="col-sm-3">
                                                                                    <form
                                                                                        action="/permintaan_cuti/{{ $data->id }}"
                                                                                        method="POST">
                                                                                        @csrf
                                                                                        <input type="hidden"
                                                                                            name="status"
                                ...
                                <div class="col-md-20">
                                                ...
                                                <div class="m-t-20">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="month" id="month"
                                                            ...
                                                            <option value="">-- Pilih Bulan --</option>
                                                            <option value="01"
                                                                {{ '01' === request()->month ? 'selected' : '' }}>Januari
                                                            </option>
                                                            <option value="02"
                                                                {{ '02' === request()->month ? 'selected' : '' }}>
                                                                Februari</option>
                                                            <option value="03"
                                                                {{ '03' === request()->month ? 'selected' : '' }}>Maret
                                                            </option>
                                                            <option value="04"
                                                                {{ '04' === request()->month ? 'selected' : '' }}>April
                                                            </option>
                                                            <option value="05"
                                                                {{ '05' === request()->month ? 'selected' : '' }}>Mei
                                                            </option>
                                                            <option value="06"
                                                                {{ '06' === request()->month ? 'selected' : '' }}>Juni
                                                            </option>
                                                            <option value="07"
                                                                {{ '07' === request()->month ? 'selected' : '' }}>Juli
                                                            </option>
                                                            <option value="08"
                                                                {{ '08' === request()->month ? 'selected' : '' }}>Agustus
                                                            </option>
                                                            <option value="09"
                                                                {{ '09' === request()->month ? 'selected' : '' }}>
                                                                September</option>
                                                            <option value="10"
                                                                {{ '10' === request()->month ? 'selected' : '' }}>Oktober
                                                            </option>
                                                            <option value="11"
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body m-b-5">
                                            <div class="row">
                                                <div class="col-md-20 col-sm-20 col-xs-20">
                                                    <table id="datatable-responsive14"
                                                        class="table dt-responsive table-striped table-bordered"
                                                        width="100%">
                                                        <thead>
                                                            <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            ...
                                                                            @if ($data->atasan_pertama == Auth::user()->id_pegawai && $data->status == 1)
                                                                                <div class="col-sm-3">
                                                                                    <form
                                                                                        action="{{ route('izinapproved', $data->id) }}"
                                                                                        method="POST">
                                                                                        @csrf
                                                                                        <input type="hidden"
                                                                                            name="status"
