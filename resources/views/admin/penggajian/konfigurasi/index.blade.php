                        ...
                        <div class="panel-heading  col-sm-15 clearfix">
                            <div class="pull-right">
                                <a href="" class="btn btn-dark btn-sm fa fa-plus" data-toggle="modal"
                                    data-target="#Modals"> Tambah Data</a>
                            </div>
                        </div>
                        <div class="panel-body m-b-5">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table id="datatable-responsive50"
                                        ...
                                        <tbody>
                                            @foreach ($kehadiran as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($data->tgl_awal)->format('d/m/Y') }} -
                                                        {{ \Carbon\Carbon::parse($data->tgl_akhir)->format('d/m/Y') }}</td>
                                                    ...
                                                    {{-- <td>
                                                        <div class="d-grid gap-2 " role="group"
                                                            ...
                                                            <a href="#" class="btn btn-info btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#Showlembur{{ $data->id }}"
