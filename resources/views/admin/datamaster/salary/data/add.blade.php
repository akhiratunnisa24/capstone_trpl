    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Tambah Data Salary</h4>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group col-sm">
                                    ...
                                    <input type="text" class="form-control" name="nama_salary"
                                        placeholder="Masukkan Nama Salary" autocomplete="off">
                                </div>
                                <div class="form-group col-sm">
                                ...
                                <div class="form-group col-sm">
                                    <label class="col-form-label">Kategori Salary</label>
                                    <select name="id_kategori" id="id_kategori" class="form-control selectpicker"
                                        data-live-search="true" required>
                                        <option>-- Pilih Kategori Salary --</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group col-sm">
                                    ...
                                    <select name="siklus_pembayaran" class="form-control selectpicker"
                                        data-live-search="true" required>
