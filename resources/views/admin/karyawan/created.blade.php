...
@section('content')
    ...
    <div class="row">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="#identitas" data-toggle="tab" class="btn btn-sm btn-warning">Sebelumnya</a>
                                                        <button type="submit" name="submit" class="btn btn-sm btn-success">Simpan</button>
                                                        <button type="button" name="submit" class="btn btn-sm btn-primary" onclick="Datakeluarga()">Selanjutnya</button>
                                                    </div>
                                                </table>
                                            </div>
                                        </div>
        ...
        {{-- next ke tabs berikutnya --}}
        <script>
            // function submitAndNext() {
            //     document.getElementById("form_identitas").submit();
            //     window.location.href = "#datakeluarga";
            // }
            // function submitAndNext() {
            //     document.getElementById("form_identitas").submit();
            //     document.querySelector('a[href="#datakeluarga"]').click();
            // }
            // function Datakeluarga() {
            //     document.getElementById("form_datakeluarga").submit();
            //     document.querySelector('a[href="#tab_lainnya"]').click();
            // }
        </script>
