                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 m-t-10">
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="text-white">B. DATA KELUARGA & TANGGUNGAN *) </label>
                                                        </div>
                                                        ...
                                                        <div class="form-group" style="margin-left:10px;margin-right:10px;">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control selectpicker" id="hubungan"
                                                        ...
                                                        <div class="form-group" style="margin-left:10px;margin-right:10px;">
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1" class="form-label">Nama
                                                                    Lengkap</label>
                                                                <input type="text" id="namaPasangan" name="namaPasangan"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1" class="form-label">Kota
                                                                    Kelahiran</label>
                                                                <input class="form-control" name="tempatlahirKeluarga"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="pekerjaanPasangan"
                                                                    class="form-control" id="pekerjaanPasangan"
                                                        ...
                                                        <div class="row">
                                                            <div class="pull-left">
                                                                <a href="/karyawancreates" class="btn btn-sm btn-info"><i
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 m-t-10">
                                                        <div
                                                            class="modal-header bg-info panel-heading  col-sm-15 m-b-10 m-t-10">
                                                            <label class="text-white">B. DATA KELUARGA DAN TANGGUNGAN *) </label>
                                                        </div>
                                                        <div class="form-group"
                                                            style="margin-left:10px;margin-right:10px;">
                                                            <div class="mb-3">
                                                                <label class="form-label">Hubungan</label>
                                                                <select class="form-control" id="hubungankeluargaa"
                                                                    name="hubungankeluarga" required>
                                                                    <option value="">Pilih Hubungan</option>
                                                                    <option value="Ayah">Ayah</option>
                                                                    <option value="Ibu">Ibu</option>
                                                        ...
                                                        <div class="form-group"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1" class="form-label">Nama
                                                                    Lengkap</label>
                                                                <input type="text" id="nama" name="namaPasangan"
                                                                    class="form-control" autocomplete="off"
                                                                    placeholder="Masukkan Nama" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" id="tempatlahir"
                                                                    name="tempatlahirKeluarga" autocomplete="off"
                                                                    rows="9"
                                                                    placeholder="Masukkan Alamat"required></input>
                                                            </div>
                                                        </div>
