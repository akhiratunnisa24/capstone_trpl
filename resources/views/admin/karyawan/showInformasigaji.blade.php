                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                <div class="col-md-6 m-t-10">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off"
                                                                    value="{{ $informasigaji ? $informasigaji->karyawans->nama : $karyawan->nama }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm">
                                                        <div class="row">
                                                            <label class="form-label col-sm-3 text-end">Tanggal
                                                                Masuk</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                @if ($karyawan->tglkeluar)
                                                                    <input type="text" class="form-control"
                                                                        autocomplete="off"
                                                                        value="{{ \Carbon\carbon::parse($karyawan->tglkeluar)->format('d/m/Y') }}"
                                                                        readonly>
                                                                @else
                                                                    <input type="text" class="form-control"
                                                    ...
                                                    <div class="form-group col-sm">
                                                        <div class="row">
                                                            <label class="form-label col-sm-3 text-end">Status
                                                                Karyawan</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off"
                                                                    value="{{ $karyawan->status_karyawan ? $karyawan->status_karyawan : 'Masukkan Status Karyawan' }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off"
                                                                    value="{{ $karyawan->gaji ? number_format($karyawan->gaji, 0, ',', '.') : 'Masukkan Gaji Pokok' }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            @if ($detailstruktur !== null)
                                                                @foreach ($detailstruktur as $data)
                                                                    <tr>
                                                                        ...
                                                                        <td>Rp.
                                                                            {{ number_format($data->nominal, 0, ',', '.') }}/{{ $data->siklus_bayar }}
                                                                        </td>
                                                                        <td>
                                                                            <a class="btn btn-info btn-sm"
                                                                                title="Edit Benefit" data-toggle="modal"
                                                                                data-target="#editD{{ $data->id }}"><i
                                                ...
                                                <div class="col-md-6 m-t-10">
                                                    <div class="form-group col-sm">
                                                        <div class="row">
                                                            <label class="form-label col-sm-3 text-end">Departemen</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off" placeholder=""
                                                                    value="{{ $karyawan->departemen->nama_departemen }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    autocomplete="off"
                                                                    value="{{ $karyawan->nama_jabatan ? $karyawan->nama_jabatan : 'Masukkan Jabatan' }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md">
                                                        <div class="row">
                                                            <label class="form-label col-sm-3 text-end">Level
                                                                Jabatan</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    name="level_jabatan" id="level_jabatan"
                                                                    autocomplete="off"
                                                                    placeholder="Masukkan Level Jabatan"
                                                                    value="{{ $karyawan->jabatan ? $karyawan->jabatan : 'Masukkan Level Jabatan' }}"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            @if ($informasigaji == null)
                                                                ...
                                                                <div class="col-sm-1">
                                                                    <a class="btn btn-success"
                                                                        ...
                                                                        title="Tambah Struktur Gaji" data-toggle="modal"
