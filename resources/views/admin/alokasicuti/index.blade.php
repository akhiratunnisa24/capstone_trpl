                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading clearfix">
                                <a href="" class="btn btn-dark btn-sm fa fa-cloud-download pull-left"
                                    data-toggle="modal" data-target="#ModalImport"> Impor Excel</a>
                            </div>
                            @include('admin.alokasicuti.importexcel')
                            <div class="panel-body m-b-5">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable-responsive24"
                                                ...
                                                @foreach ($alokasicuti as $data)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="row">
                                                                <a id="bs" class="btn btn-info btn-sm showalokasi"
                                                                    data-toggle="modal"
                                                                    data-target="#showalokasi{{ $data->id }}"><i
                                                                        class="fa fa-eye" title="Lihat Detail"></i>
                                                                </a>
