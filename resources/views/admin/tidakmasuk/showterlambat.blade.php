...
@section('content')
                                        ...
                                        @foreach ($terlambat as $t)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/terlambat-detail{{ $t->id_karyawan }}"
                                                        class="btn btn-info btn-sm"><i class="fa fa-eye"
                                                            title="Lihat Detail"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        @foreach ($telat as $te)
                                            <tr>
                                                ...
                                                <td>{{ $te->sanksi }}</td>
                                                <td class="text-center">
                                                    <a href="/terlambat-detail{{ $te->id_karyawan }}"
                                                        class="btn btn-info btn-sm"><i class="fa fa-eye"
                                                            title="Lihat Detail"></i></a>
                                                </td>
                                            </tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <table id="datatable-responsive21"
                                    class="table table-responsive dt-responsive table-striped table-bordered"
                                    width="100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach ($datatelat as $tel)
                                            <tr>
                                                ...
                                                <td>{{ $tel->sanksi }}</td>
                                                <td class="text-center">
                                                    <a href="/terlambat-detail{{ $tel->id_karyawan }}"
                                                        class="btn btn-info btn-sm"><i class="fa fa-eye"
                                                            title="Lihat Detail"></i></a>
                                                </td>
                                            </tr>
    ...
    @endif
    <a href="/" class="btn btn-sm btn-danger pull-right" style="margin-right:15px;">Kembali <i
