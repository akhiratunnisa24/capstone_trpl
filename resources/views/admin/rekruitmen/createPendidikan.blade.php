                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-20 col-sm-20 col-xs-20" style="margin-left:15px;margin-right:15px;">
                                ...
                                <form action="/storep_formal" method="POST" id="formCreatePendidikan" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-bordered table-striped">
                                                <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="date"  class="form-control" placeholder="yyyy" id="4"
                                                    ...
                                                    <div class="row">
                                                        <div class="pull-left">
                                                            <a href="/create_kontak_darurat" class="btn btn-sm btn-info"><i class="fa fa-backward"></i> Sebelumnya</a>
                                                        </div>
                                                        <div class="pull-right">
                                                            <button type="submit" name="submit" class="btn btn-sm btn-dark">Simpan</button>
                                                            <a href="/create_data_pekerjaan" class="btn btn-sm btn-success">Selanjutnya <i class="fa fa-forward"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </table>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Tahun Lulus</label>
                                                                    <div class="input-group">
                                                                        <input id="tahun_lulusFormal" type="date"  class="form-control" placeholder="yyyy" id="4"
                                                                                name="tahun_lulusFormal" rows="10" autocomplete="off"><br>
                                                                        {{-- <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span> --}}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">No. Ijazah</label>
                                                                    <input type="number" id="noijazahPformal" name="noijazahPformal"  class="form-control" aria-describedby="emailHelp"   placeholder="Masukkan No. Ijazah" autocomplete="off">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Lembaga Pendidikan</label>
                                                                    <input type="text" id="namaLembaga" name="namaLembaga" class="form-control" placeholder="Masukkan Nama Lembaga" autocomplete="off"> 
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Alamat</label>
                                                                    <input type="text" id="alamatNonformal" name="kotaPendidikanNonFormal"  class="form-control"   placeholder="Masukkan Alamat" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Lulus Tahun</label>
                                                                    <div class="input-group">
                                                                        <input id="tahunLulusNonFormal" type="date" class="form-control" placeholder="yyyy" id="4"
                                                                                name="tahunLulusNonFormal" autocomplete="off" rows="10" ><br>
                                                                        {{-- <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span> --}}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label class="form-label">No. Ijazah</label>
                                                                    <input type="number" id="noijazahPnonformal" name="noijazahPnonformal"  class="form-control" aria-describedby="emailHelp"   placeholder="Masukkan No. Ijazah" autocomplete="off">
                                                                </div>
                                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#editPendidikan', function() {
                ...
                // Isi data ke dalam form
                    ...
                    $('#tahunLulusNonFormal').val(data.tahun_lulus_nonformal);
