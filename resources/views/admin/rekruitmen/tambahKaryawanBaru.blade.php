                    ...
                    <div class="row" style="margin-top: 30px">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Form Data Karyawan Baru</h4>
                                                                    ...
                                                                    <div class="row">
                                                                        <div>
                                                                            <div
                                                                                ...
                                                                                <label class="text-white m-b-10">A.
                                                                                    IDENTITAS DIRI</label>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 m-t-10">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="exampleInputEmail1"
                                                                                        class="form-label col-sm-4">Pilih
                                                                                        Foto Karyawan</label>
                                                                                    <img
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-20 col-sm-20 col-xs-20">
                                                ...
                                                <form action="/storedatakeluarga" method="POST"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-20 col-sm-20 col-xs-20">
                                                ...
                                                <form action="/storekontakdarurat" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    @method('post')
                                                    <div class="control-group after-add-more">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="pull-right">
                                                                                <button type="submit" name="submit"
                                                                                    class="btn btn-sm btn-primary">Simpan</button>
                                                                                <a href="#riwayatpendidikan"
                                                                                    data-toggle="tab"
                                                                                    class="btn btn-sm btn-danger">Selanjutnya</a>
                                                                            </div>
                                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-20 col-sm-20 col-xs-20">
                                                <table id="datatable-responsive8"
                                                    class="table dt-responsive nowrap table-striped table-bordered"
                                                    cellpadding="0" width="100%">
                                                    <span class="badge badge-info"><strong>A. PENDIDIKAN
                                                            FORMAL</strong></span>
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                ...
                                                <span class="badge badge-info"><strong>B. PENDIDIKAN NON
                                                        FORMAL</strong></span>
                                                <table id="datatable-responsive9"
                                                    class="table dt-responsive nowrap table-striped table-bordered"
                                                    cellpadding="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                ...
                                                <form action="/storepformal" method="POST"
                                                    enctype="multipart/form-data">
                                                    <div class="control-group after-add-more">
                                                        @csrf
                                                        @method('post')
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div
                                                                                class="modal-header bg-info panel-heading  col-sm-15 m-b-5 ">
                                                                                <label class="text-white">Pendidikan
                                                                                    Formal</label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="exampleInputEmail1"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-20 col-sm-20 col-xs-20">
                                                ...
                                                <form action="/storepekerjaan" method="POST"
                                                    enctype="multipart/form-data">
                                                    <div class="control-group after-add-more">
                                                        @csrf
                                                        @method('post')
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <div>
                                                                            <div
                                                                                class="modal-header bg-info panel-heading  col-sm-15 m-b-5">
                                                                                <label class="text-white m-b-10">E.
                                                                                    Riwayat
                                                                                    Pekerjaan</label>
                                                                            </div>
                                                                        </div>
