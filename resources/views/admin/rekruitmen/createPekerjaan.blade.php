                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-20 col-sm-20 col-xs-20" style="margin-left:15px;margin-right:15px;">
                                ...
                                <form action="/store_pekerjaan" id="formCreatePekerjaan"  method="POST" enctype="multipart/form-data">
                                    <div class="control-group after-add-more">
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <div class="row">
                                                    <div class="pull-left">
                                                        <a href="/create_data_pendidikan" class="btn btn-sm btn-info"><i class="fa fa-backward"></i> Sebelumnya</a>
                                                    </div>
                                                    <div class="pull-right">
                                                        <button type="submit" name="submit" class="btn btn-sm btn-dark"> Simpan</button>
                                                         <a href="/create_data_organisasi" class="btn btn-sm btn-success">Selanjutnya <i class="fa fa-forward"></i></a>
                                ...
                                <form action="/update_pekerjaan" id="formUpdatePekerjaan"  method="POST" enctype="multipart/form-data">
                                    {{-- <div class="control-group after-add-more"> --}}
                                        @csrf
                                        @method('post')
                                        <div class="modal-body">
                                        ...
                                        <input type="hidden" name="nomor_index"
                                                        ...
                                                        <div class="col-md-6 m-t-10">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="mb-3">  
                                                                    <label for="exampleInputEmail1" class="form-label">Level / Pangkat / Golongan</label>
                                                                    <input type="text" id="levelRpekerjaan" name="levelRpekerjaan" class="form-control" placeholder="Masukkan Level" autocomplete="off">
                                                                </div>
                                                            </div>
