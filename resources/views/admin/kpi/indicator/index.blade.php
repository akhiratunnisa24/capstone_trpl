    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="page-header-title">
                <h4 class="pull-left page-title">Data Indicator KPI</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading  clearfix">
                            <a href="" class="btn btn-sm btn-dark fa fa-plus pull-right" data-toggle="modal" data-target="#addJob"> Tambah Indicator</a>
                        </div>
