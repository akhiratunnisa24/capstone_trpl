    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="page-header-title">
                <h4 class="pull-left page-title">Master Partner</h4>

                <ol class="breadcrumb pull-right">
                    <li>Human Resources Management System</li>
                    <li class="active">Master Partner</li>
                </ol>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading  clearfix">
                            <a href="" class="btn btn-sm btn-dark fa fa-plus pull-right" data-toggle="modal"
                                data-target="#AddModal"> Tambah Data Partner</a>
                        </div>
                        @include('superadmin.partner.add')
                            ...
                            <table id="datatable-responsive42" class="table dt-responsive nowrap table-striped table-bordered" cellpadding="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($partner as $data)
                                        ...
                                        @include('superadmin.partner.edit')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
        ...
        function hapus(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    location.href = '<?= '/partner/delete' ?>' + id;
