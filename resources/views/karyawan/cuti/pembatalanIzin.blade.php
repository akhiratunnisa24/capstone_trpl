...
<link href="assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
    ...
    <div class="modal modal fade" id="Batalizin{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title text-center" id="Modal">FORM PEMBATALAN KETIDAKHADIRAN KARYAWAN</h4>
                </div>
                ...
                <div class="modal-body">
                    <form action="/pembatalan-izin/{{$data->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group col-sm">
                                        ...
                                        <input type="text" class="form-control"value="{{$datakry->nik}}"  name="nik" id="nik" readonly>
                                        <input type="hidden" class="form-control"value="{{$datakry->id}}"  name="id" id="id" readonly>
                                    </div>         
                                    <div class="form-group col-sm">
                                ...
                                <div class="col-md-6">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" onchange=(jumlahcutis()) value="{{\Carbon\Carbon::parse($data->tgl_mulai)->format("d/m/Y")}}" placeholder="dd/mm/yyyy"  name="tgl_mulai"  autocomplete="off" rows="10" readonly>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" onchange=(jumlahcutis()) placeholder="dd/mm/yyyy" value="{{\Carbon\Carbon::parse($data->tgl_selesai)->format("d/m/Y")}}" name="tgl_selesai"  autocomplete="off" rows="10" readonly>
                                                        <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-sm">
                                        ...
                                        <textarea class="form-control" name="keperluan" id="keperluan" rows="5" placeholder="Masukkan keterangan" autocomplete="off" readonly>{{$data->keperluan}}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="form-group col-sm">
                                                ...
                                                <input type="text" class="form-control" value="{{$data->jml_hari}}" name="jml_cuti" id="jumlahh" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="submit-button" class="btn btn-sm btn-warning" value="save">Kirim Pembatalan</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        function jumlahcutis()
        {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#jumlahh').val(daysOfYear.length ?? 0);
                } 
            });
        };
    </script> --}}
