                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" placeholder="dd/mm/yyyy" id="datepicker-autoclose" name="tglmasuk" rows="10"></input><br>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">Tanggal Keluar</label>
                                                                            <div class="input-group" disable>
                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" id="datepicker" name="tglkeluar" rows="10" disabled></input><br>
                                                                                <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span>
                                                                            </div><!-- input-group -->
                                                                    </div>                                                                 
