...
Route::get('/slipgaji-grup{id}', [PenggajianController::class, 'showslipgrup'])->name('showslipgroup');
Route::put('/slipgaji-karyawan-grup/rekening/{id}', [PenggajianController::class, 'updateRekening'])->name('updateRekening');
