...
class CutikaryawanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $cuti = DB::table('cuti')
            ...
            ->select('cuti.*', 'departemen.nama_departemen','karyawan.nama','jeniscuti.jenis_cuti','statuses.name_status','datareject.alasan as alasan','datareject.id_cuti as id_cuti')
        ...
        $izin = Izin::leftjoin('statuses','izin.status','=','statuses.id')
            ...
            ->select('izin.*','jenisizin.jenis_izin','karyawan.nama','departemen.nama_departemen','statuses.name_status','datareject.alasan as alasan','datareject.id_izin as id_izin')
